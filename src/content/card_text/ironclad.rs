...
use crate::core::query::{BlockCalc, DamageCalc};
use crate::core::rules::RulePipeline;
use crate::core::state::{decimal_to_i32_trunc, CardCounter};
#[cfg(test)]
use crate::core::state::{CardCosts, GameState};
#[cfg(test)]
use crate::registry::StaticRegistry;

use super::{CardTextCtx, CardTextLine, CardTextScope};
...
mod tests {
    ...
    use crate::content::card_text::{describe_card, CardTextCtx, CardTextScope};
