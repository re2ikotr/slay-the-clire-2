...
const UI_TEXT: &[LocalizedEntry] = &[
    ...
    LocalizedEntry { key: "help.tui.compact", eng: "Keys: arrows target/card, 1-9 select, Enter play, e/r/l/q/?", zhs: "按键：方向键目标/手牌，1-9 选择，Enter 出牌，e/r/l/q/?" },
    LocalizedEntry { key: "help.tui.full", eng: "Left/right or number keys select a card; targetable cards focus monsters. Up/down moves target, Enter plays.", zhs: "左右或数字键选择手牌；需要目标的牌会聚焦怪物。上下切换目标，Enter 打出。" },
