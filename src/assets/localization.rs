...
const ENTITY_NAMES: &[LocalizedEntry] = &[
    ...
    // ---- Token cards ----
    LocalizedEntry { key: "card.FUEL", eng: "Fuel", zhs: "燃料" },
    LocalizedEntry { key: "card.LUMINESCE", eng: "Luminesce", zhs: "冷光" },
    LocalizedEntry { key: "card.MINION_DIVE_BOMB", eng: "Minion Dive Bomb", zhs: "仆从俯冲" },
    LocalizedEntry { key: "card.MINION_SACRIFICE", eng: "Minion Sacrifice", zhs: "仆从捐躯" },
    LocalizedEntry { key: "card.MINION_STRIKE", eng: "Minion Strike", zhs: "仆从打击" },
    LocalizedEntry { key: "card.SHIV", eng: "Shiv", zhs: "小刀" },
    LocalizedEntry { key: "card.SOUL", eng: "Soul", zhs: "灵魂" },
    LocalizedEntry { key: "card.SOVEREIGN_BLADE", eng: "Sovereign Blade", zhs: "君王之剑" },
    LocalizedEntry { key: "card.SWEEPING_GAZE", eng: "Sweeping Gaze", zhs: "扫荡凝视" },
    LocalizedEntry { key: "card.DISINTEGRATION", eng: "Disintegration", zhs: "瓦解" },
    LocalizedEntry { key: "card.MIND_ROT", eng: "Mind Rot", zhs: "心灵腐化" },
    LocalizedEntry { key: "card.SLOTH", eng: "Sloth", zhs: "懒惰" },
    LocalizedEntry { key: "card.WASTE_AWAY", eng: "Waste Away", zhs: "衰朽" },
    // ---- Curse cards ----
    LocalizedEntry { key: "card.ASCENDERS_BANE", eng: "Ascender's Bane", zhs: "进阶之灾" },
    LocalizedEntry { key: "card.BAD_LUCK", eng: "Bad Luck", zhs: "霉运" },
    LocalizedEntry { key: "card.CLUMSY", eng: "Clumsy", zhs: "笨拙" },
    LocalizedEntry { key: "card.CURSE_OF_THE_BELL", eng: "Curse of the Bell", zhs: "铃铛的诅咒" },
    LocalizedEntry { key: "card.DEBT", eng: "Debt", zhs: "债务" },
    LocalizedEntry { key: "card.DECAY", eng: "Decay", zhs: "腐朽" },
    LocalizedEntry { key: "card.DOUBT", eng: "Doubt", zhs: "疑虑" },
    LocalizedEntry { key: "card.ENTHRALLED", eng: "Enthralled", zhs: "执迷" },
    LocalizedEntry { key: "card.FOLLY", eng: "Folly", zhs: "愚行" },
    LocalizedEntry { key: "card.GREED", eng: "Greed", zhs: "贪婪" },
    LocalizedEntry { key: "card.GUILTY", eng: "Guilty", zhs: "愧疚" },
    LocalizedEntry { key: "card.INJURY", eng: "Injury", zhs: "受伤" },
    LocalizedEntry { key: "card.NORMALITY", eng: "Normality", zhs: "凡庸" },
    LocalizedEntry { key: "card.POOR_SLEEP", eng: "Poor Sleep", zhs: "睡眠不佳" },
    LocalizedEntry { key: "card.REGRET", eng: "Regret", zhs: "悔恨" },
    LocalizedEntry { key: "card.SHAME", eng: "Shame", zhs: "羞耻" },
    LocalizedEntry { key: "card.SPORE_MIND", eng: "Spore Mind", zhs: "孢子心灵" },
    LocalizedEntry { key: "card.WRITHE", eng: "Writhe", zhs: "苦恼" },
];
